...
ALLOWED_HOSTS = ["hashflix-django-production.up.railway.app", "localhost", "127.0.0.1"]
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'filme.context.lista_filmes_frequentes',
...
DATABASE_URL = "postgres://postgres:3cG2dcbe3C25F2GdA*adgAeA1D66ce1E@viaduct.proxy.rlwy.net:42593/railway"
if DATABASE_URL:
    DATABASES = {
